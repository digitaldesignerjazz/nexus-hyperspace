...
[![Status](https://img.shields.io/badge/Status-Phase%201%20Foundation-blue)](ROADMAP.md)
...
See the full layered architecture in [ARCHITECTURE.md](ARCHITECTURE.md). The system follows a clean separation:
...
Detailed phased milestones in [ROADMAP.md](ROADMAP.md):
